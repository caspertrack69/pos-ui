...
import 'package:pos_ui/module/login/view/login_view.dart';
import 'package:pos_ui/module/onboarding/view/community/index.dart';
import 'package:pos_ui/module/onboarding/view/education/index.dart';
import 'package:pos_ui/module/onboarding/view/onboarding_view.dart';
import 'package:pos_ui/module/onboarding/view/work/index.dart';
import 'package:pos_ui/module/onboarding/widget/header.dart';
import 'package:pos_ui/module/onboarding/widget/nextpagebutton.dart';
import 'package:pos_ui/module/onboarding/widget/onboardingViewIndicator';
import 'package:pos_ui/module/onboarding/widget/ripple.dart';
...
class _OnboardingState extends State<Onboarding> with TickerProviderStateMixin {
  ...
  Future<void> _goToLogin() async {
    ...
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (_) => LoginView(screenHeight: widget.screenHeight),
      ),
    );
  }
